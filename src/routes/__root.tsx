...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MatchPad" },
      { name: "description", content: "Live football scoring and tournament management for grassroots football. Track matches, teams, players, stats, and standings in real time" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "MatchPad" },
      { property: "og:description", content: "Live football scoring and tournament management for grassroots football. Track matches, teams, players, stats, and standings in real time" },
